<section class="flex flex-col gap-10 max-w-screen-2xl mx-auto justify-center items-center pt-10 pb-30 px-2 md:px-16 font-sans bg-linear-to-b from-white via-white via-88% to-brand-blue_4">
